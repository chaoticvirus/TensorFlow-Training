...
exports.dialogflowFirebaseFulfillment = functions.https.onRequest((request, response) => {
  ...
  function getweather(agent) {
    ...
    return new Promise((resolve, reject) => {
        ...
        let weatherApiKey = '71a47abcd9c429a47f624df77417419d';
        let path = "/data/2.5/weather?q=" + city + "&appid=" + weatherApiKey;
        ...
        http.get({host: host, path: path}, function(res) {
            ...
            res.on('end', function(){
                ...
                let ouput = agent.add(city + ' has ' + current + ' now');
                resolve(ouput);
            });
        }).on('error', function(error){
                console.log("Error: " + error.message);
                let ouput = agent.add("Sorry!");
                reject(ouput);
        });
    });
  }
